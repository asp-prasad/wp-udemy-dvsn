    ...
    class UFWP_Courses_Widget extends WP_Widget {
        ...
        function __construct() {
            parent::__construct(
                ...
                __( 'UFWP - Courses', 'wp-udemy-dvsn' ), // Name
                array( 'description' => __( 'Displaying courses by their ids.', 'wp-udemy-dvsn' ), ) // Args
            );
        }
        ...
        public function widget( $args, $instance ) {
            ...
            if ( empty( $instance['ids'] ) ) {
                esc_attr_e( 'Please enter a course ID.', 'wp-udemy-dvsn' );
            }
        ...
        public function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php esc_attr_e( $this->get_field_id( 'title' ) ); ?>"><?php esc_attr_e( 'Title:', 'wp-udemy-dvsn' ); ?></label>
            ...
            <p>
                <label for="<?php esc_attr_e( $this->get_field_id( 'ids' ) ); ?>"><?php esc_attr_e( 'Course IDs:', 'wp-udemy-dvsn' ); ?></label>
                ...
                <br />
                <small>
                    <?php esc_attr_e( 'You can enter multiple course IDs and separate them by comma.', 'wp-udemy-dvsn' ); ?>
                </small>
            </p>
            ...
            ?>
            <p>
                <label for="<?php esc_attr_e( $this->get_field_id( 'template' ) ); ?>"><?php esc_attr_e( 'Template:', 'wp-udemy-dvsn' ); ?></label>
            ...
            ?>
            <p>
                <label for="<?php esc_attr_e( $this->get_field_id( 'style' ) ); ?>"><?php esc_attr_e( 'Style:', 'wp-udemy-dvsn' ); ?></label>
            ...
            <p>
                <label for="<?php esc_attr_e( $this->get_field_id( 'url' ) ); ?>"><?php esc_attr_e( 'Custom URL:', 'wp-udemy-dvsn' ); ?></label>
                ...
                <br />
                <small>
                    <?php esc_attr_e( 'Only working when entering one course id.', 'wp-udemy-dvsn' ); ?>
                </small>
            </p>
            <?php } ?>
